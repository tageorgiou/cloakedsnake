...
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=160mm]{graphs/slowpickle.png}
%   \caption{Python Pickle module benchmark. Min Iteration: changed from 0.705s to 0.681s: 1.04 times faster. Average iteration: changed from 0.710s to 0.686s: 1.04 times faster. Standard deviation of new implementation 2.0383 times smaller}
% \end{figure}
