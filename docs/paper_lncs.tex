...
%
\authorrunning{A Reimplementation of Python’s dict}
...
\keywords{Hashing, Simple Tabulation}
\end{abstract}
...
dictionaries in CPython 2.7.3 \cite{python27}.  We should note that Python's dictionary supports
