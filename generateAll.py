...
versions = {
        ...
        'thm8': '-DINSTRUMENT_DICT -DTABULATION_MAIN',
...
#        'lpthm4': '-DINSTRUMENT_DICT -DLINEAR_PROBING -DTABULATION_MAIN -DTABLE_MASK=3',
        'lpthm8': '-DINSTRUMENT_DICT -DLINEAR_PROBING -DTABULATION_MAIN -DTABLE_MASK=7 -DTABLE2',
        'lpthm8pf': '-DINSTRUMENT_DICT -DLINEAR_PROBING -DTABULATION_MAIN -DTABLE_MASK=7 -DTABULATION_PREFETCH',
        'lpthm8t2': '-DINSTRUMENT_DICT -DLINEAR_PROBING -DTABULATION_MAIN -DTABLE_MASK=7 -DTABLE2',
